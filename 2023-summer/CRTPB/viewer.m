...
w = animatedline("Marker",".","MarkerSize",10,MaximumNumPoints=5);
wl = animatedline("Marker",".","MarkerSize",10,MaximumNumPoints=5);
we = animatedline("Marker",".","MarkerSize",10,MaximumNumPoints=5);
